...
namespace AttendanceTracking.Data.Profiles
{
	public class AttendanceResponseProfile:Profile
	{
        public AttendanceResponseProfile() {
            ...
            .ForMember(dest => dest.totalPresentTime, opt => opt.MapFrom(src => src.totalPresentTime))
            .ForMember(dest => dest.totalHoursInOffice, opt => opt.MapFrom(src => src.totalHoursInOffice))
